...
### 🦇 Skillsets
I am a learner, always try to learn new things, and am not afraid to explore new things (i.e., analysis, concepts, taxa groups, and other biological fields). My undergraduate thesis focused on studying the genetics population and karyotype (mapping the metaphase chromosomes) of Diadem's round leaf bats (*Hipposideros diadema*), the populations were separated by the physical barrier of mountain ranges that stretch out in the middle of Sumatra Island from north to the south. Here I learned a lot about how to conduct scientific research, trained in how to collect data in the field, learned how to conduct lab work, analyze the data, and learned to write them up. I would say that this is the most crucial part of my life that got me into what I am doing today. I trained myself much more during my master's degree, in various taxa (small mammals, birds, freshwater fishes), sampling in so many places, and countless fieldwork. I learned a lot from peers, teachers, mentors, and friends. (continue later).
